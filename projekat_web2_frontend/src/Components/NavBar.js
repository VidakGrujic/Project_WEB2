...
const NavBar = ({isAuth, tipKorisnika}) => {
    ...
    return (
        <div className="ui blue secondary pointing menu">
            ...
            {isAuth && tipKorisnika === 'Prodavac' ? <NavLink className={({isActive}) => active(isActive)} to="/prodavacDodajArtikal">Prodavac dodaj artikal</NavLink> : null}
            {isAuth && tipKorisnika === 'Prodavac' ? <NavLink className={({isActive}) => active(isActive)} to="/prodavacNovePorudzbine">Prodavac nove porudzbine</NavLink> : null}
            {isAuth && tipKorisnika === 'Prodavac' ? <NavLink className={({isActive}) => active(isActive)} to="/prodavacMojePorudzbine">Prodavac moje porudzbine</NavLink> : null}
